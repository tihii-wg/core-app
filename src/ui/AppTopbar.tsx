    ...
    <header className="h-14 bg-white border-b border-[#eeeeef] flex items-center justify-between px-4 sticky top-0 z-30">
      ...
      <div className="flex items-center gap-4">
        ...
        <button
          ...
          className="lg:hidden p-2 -ml-2 text-[#939699] hover:text-[#282e33]"
        >
          <Menu className="h-5 w-5" />
        </button>

        {/* Page title */}
        <h1 className="text-lg font-semibold text-[#282e33]">
      ...
      <div className="flex items-center gap-3">
        ...
        <DropdownMenu>
          <DropdownMenuTrigger asChild>
            <Button
              variant="ghost"
              size="icon"
              className="relative h-9 w-9 text-[#939699] hover:text-[#282e33]"
            >
          ...
          <DropdownMenuContent align="end" className="w-80">
            <DropdownMenuLabel className="flex items-center justify-between">
              ...
              <span className="text-xs font-normal text-[#1973e1] cursor-pointer hover:underline">
                Mark all read
              </span>
            </DropdownMenuLabel>
            <DropdownMenuSeparator />
            {notifications.map((notification) => (
              ...
              >
                ...
                <span className="text-xs text-[#939699]">
                  {notification.time}
                </span>
              </DropdownMenuItem>
            ))}
            <DropdownMenuSeparator />
            <DropdownMenuItem className="text-center text-[#1973e1] cursor-pointer justify-center">
        ...
        <DropdownMenu>
          <DropdownMenuTrigger asChild>
            <Button
              variant="ghost"
              className="hidden sm:flex items-center gap-2 h-9 px-3 text-sm text-[#282e33]"
            >
          ...
          <DropdownMenuContent align="end">
            ...
            <DropdownMenuItem className="cursor-pointer text-[#1973e1]">
              + Add company
            </DropdownMenuItem>
          </DropdownMenuContent>
        </DropdownMenu>
          ...
          <DropdownMenuContent align="end" className="w-56">
            <DropdownMenuLabel>
              <div className="flex flex-col">
                ...
                <span className="text-xs text-[#939699] font-normal">
                  {auth.user?.email}
                </span>
              </div>
            </DropdownMenuLabel>
            ...
            <DropdownMenuSeparator />
            <DropdownMenuItem
              className="cursor-pointer text-[#f41f20] focus:text-[#f41f20]"
              onClick={logout}
            >
