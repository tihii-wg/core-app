  ...
  const columns: Column<Client>[] = [
    ...
    },
    {
      ...
      cell: (client) => (
        <span
          className={
            client.balance > 0 ? 'text-[#f41f20] font-medium' : 'text-[#282e33]'
          }
        >
          ${client.balance}
        </span>
    ...
    },
    {
      ...
      header: 'Added',
      cell: (client) => (
        <span className="text-[#939699]">{client.createdAt}</span>
      ),
              ...
              <div className="bg-[#f8f9fa] rounded-md p-4">
                ...
                <p
                  className={`text-2xl font-semibold ${
                    selectedClient.balance > 0 ? 'text-[#f41f20]' : 'text-[#282e33]'
                  }`}
                >
              ...
              <div>
                ...
                {(() => {
                  ...
                  if (clientOrders.length === 0) {
                    return (
                      <p className="text-sm text-[#939699] py-4 text-center">
                        No orders yet
                      </p>
                    );
                  }
                  return (
                    <div className="space-y-2">
                      {clientOrders.slice(0, 5).map((order) => (
                        <div
                          key={order.id}
                          className="flex items-center justify-between p-3 bg-[#f8f9fa] rounded-md"
                        >
                          <div>
